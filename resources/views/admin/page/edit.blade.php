            ...
            @csrf
                <div class="p-6 bg-white border-b border-gray-200 flex-row">
                    <div class="flex-1 px-4">
                        ...
                        <input class="civanoglu-input" type="text" id="name" name="name" value="{{$page->name}}">
                        @error('name')
                    ...
                    <div class="flex-1 px-4">
                        ...
                        <input class="civanoglu-input" type="text" id="slug" name="slug" value="{{$page->slug}}">
                        @error('slug')
                        <p class="text-red-500 mt-2 text-sm">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="flex-1 px-4">
                        ...
                        <input class="civanoglu-input" type="text" id="content" name="content" value="{{$page->content}}">
                        @error('content')
                        <p class="text-red-500 mt-2 text-sm">{{$message}}</p>
                        @enderror
                    </div>
